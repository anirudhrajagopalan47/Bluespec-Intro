...
/* Generation options: */
#ifndef __model_mkSwap_h__
#define __model_mkSwap_h__
...
/* Class declaration for a model of mkSwap */
class MODEL_mkSwap : public Model {
 
 /* Top-level module instance */
 private:
  MOD_mkSwap *mkSwap_instance;
...
#endif /* ifndef __model_mkSwap_h__ */
